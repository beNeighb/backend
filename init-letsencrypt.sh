...
domain=api.beneighb.com
rsa_key_size=4096
data_path="./data/certbot"
email="mhryshyn@gmail.com" # Adding a valid address is strongly recommended
...
path="./data/certbot/conf/live/$domain"
echo "PAAAAATH !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
...
#     -subj '/CN=localhost'" certbot
  ...
  #   -subj '/CN=localhost'
  openssl req -x509 -nodes -newkey rsa:$rsa_key_size -days 1\
    -keyout './data/certbot/conf/live/api.beneighb.com/privkey.pem' \
    -out './data/certbot/conf/live/api.beneighb.com/fullchain.pem' \
    -subj '/CN=localhost'
echo
